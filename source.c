...
#define TOKEN2  0x01000CFC//0xFC0C0001
#define TOKEN21 0x01000BFC


#define TOKEN17 0x02000AFC
#define TOKEN20 0x02000DFC
#define TOKEN22 0x020017FC
...
#define TOKEN3  0x020000FC//0xFC0B0002
#define TOKEN5  0x040000FC//0xFC000004
#define TOKEN7  0x050000FC  //CPU
...
int main()
{
	...
	while(!feof(fp))
	{
		...
		Buffer3 = 0;
		memcpy(&Buffer3,ReadBuffer,sizeof(Buffer3));
		if(((ReadBuffer[3] == 0x05)||(ReadBuffer[3] == 0x04)||(ReadBuffer[3] == 0x02))&&(ReadBuffer[0] == 0xFC))
		{
